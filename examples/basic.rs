...
////////////////////////////////////////////////////////////////////////////
  ...
  // let (u,s,vt) = rho_max_mixed_2_qbit.svd(true,true).unwrap();
  // println!("{:?}",vt);

  // println!("{}", fibc(Complex::new(2.0,2.0)));
  // println!("{}", find_matrix_sqrd(array![ [c64::new(3., 1.) , c64::new(-1., 1.) ],
...
let huge_array = array![ [0.000000000000000000e+00, 0.000000000000000000e+00, 0.000000000000000000e+00, 0.000000000000000000e+00, 0.000000000000000000e+00, 7.021809714456165265e-16, 4.021293951545408608e-09, 1.570136766519117454e-06, 1.041760284915982798e-01, 9.080741470819553296e-01],
